# Alerta específico — dengue × SORRISO
...
- SORRISO: +0.0 (0.0) · 0,0 positivos por 100 mil habitantes

## 4. Vizinhos (a partir do município do sinal)

- LUCAS DO RIO VERDE ↔ SORRISO: +0.0/+0.0 (exames 712.0/194.0)
- SORRISO ↔ VERA: +0.0/+0.0 (exames 194.0/9.0)
- SORRISO ↔ IPIRANGA DO NORTE: +0.0/+0.0 (exames 194.0/18.0)
- SORRISO ↔ LUCAS DO RIO VERDE: +0.0/+0.0 (exames 194.0/712.0)
...
- CIEVS: Priorizar investigação de dengue em SORRISO: cruzar lab × notificação, avaliar definição de caso e comunicação com VE municipal.
- VE municipal: Investigar casos/contatos de dengue em SORRISO; verificar oportunidade de notificação e busca ativa.
